...
module demux (s0,s1,i,y0,y1,y2,y3);
input i,s0,s1;
output y0,y1,y2,y3;
wire s0bar,s1bar;
not(s0bar,s0);
...
MULTIPLEXER:
![Exercise-07-Multiplexer-and-De-multiplexer](mux2.png)

DEMULTIPLEXER:
![Exercise-07-Multiplexer-and-De-multiplexer](demux2.png)


### TIMING DIGRAMS  

MULTIPLEXER:
![Exercise-07-Multiplexer-and-De-multiplexer](mux1.png)

DEMULTIPLEXER:
![Exercise-07-Multiplexer-and-De-multiplexer](demux1.png)
